...
def _init_builder_args(ctx, rule_kind, module_name):
    ...
    args.add("--kotlin_passthrough_flags", "-Xopt-in=kotlinx.coroutines.ExperimentalCoroutinesApi,-Xallow-result-return-type,-Xinline-classes,-Xuse-experimental=kotlin.Experimental")
